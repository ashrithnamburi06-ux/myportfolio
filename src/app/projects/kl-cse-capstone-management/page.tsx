...
export default function CapstoneCaseStudyPage() {
  ...
  const verifiedTechStack = [
    { name: "React", category: "Frontend UI Framework", desc: "v19.2.7 Component Architecture" },
    { name: "Vite", category: "Build Tooling & Dev Server", desc: "v8.1.1 Fast HMR Engine" },
    { name: "Firebase Auth", category: "Authentication Service", desc: "Identity & Password Management" },
    { name: "Cloud Firestore", category: "NoSQL Database", desc: "Real-time Multi-Collection Store" },
    { name: "Tailwind CSS", category: "Styling Framework", desc: "v3.4 Responsive UI Design" },
    { name: "PapaParse", category: "CSV Data Engine", desc: "v5.5 Bulk Import Parser" },
    { name: "XLSX", category: "Spreadsheet Engine", desc: "v0.18 SheetJS Excel Sync" },
    { name: "jsPDF", category: "Document Generation", desc: "v4.2 PDF Report Exporter" },
    { name: "React Router DOM", category: "Routing System", desc: "v7.18 Role-Based Navigation" },
    { name: "Recharts", category: "Data Visualization", desc: "v3.10 Evaluation Analytics" }
  ];
        ...
        <div className="bg-white dark:bg-[#03120A]/90 border border-slate-200 dark:border-emerald-900/40 rounded-3xl p-6 sm:p-10 mb-10 shadow-xl relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl space-y-5">
            ...
            <p className="text-slate-700 dark:text-gray-300 text-base sm:text-lg leading-relaxed max-w-3xl">
              Designed and engineered a production-ready academic capstone management platform for the KL University CSE department. Centralizes student/team assignments, multi-role evaluator workflows, rubric-driven assessments, per-student attendance, review cycle tracking, and administrative evaluation aggregation.
            </p>
            ...
            {/* ACTION BUTTONS (VERIFIED GITHUB LINK ONLY) */}
        ...
        <div className="bg-emerald-50 dark:bg-[#051F10] border border-emerald-300 dark:border-emerald-600/40 rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-md">
          <div>
            ...
            <p className="text-xs text-slate-700 dark:text-gray-300">
              Verified full-stack academic project management platform built by Ashrit Krishna.
            </p>
          </div>
