...
export const GRStylesCaseStudyClient: React.FC = () => {
  const [activeTab, setActiveTab] = useState(0);
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [activeArchLayer, setActiveArchLayer] = useState<string | null>("backend");

  const grStylesProject = portfolioConfig.projects.find((p) => p.id === "gr-styles");
  const liveDemoUrl = grStylesProject?.liveDemoUrl || "https://www.grstyles.com/";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-12 border-b border-slate-200 dark:border-emerald-900/40 pb-10">
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-emerald-100 dark:bg-emerald-950 border border-emerald-300 dark:border-emerald-700/60 text-emerald-900 dark:text-emerald-300 text-xs font-bold uppercase tracking-wider">
            ...
            <p className="text-slate-700 dark:text-gray-300 text-base leading-relaxed">
              A full-stack, responsive and feature-rich online shopping platform built with Python, Django, MySQL, and modern web UI technologies by Ashrith Namburi.
            </p>
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="relative w-full max-w-[480px] bg-[#0A1910] rounded-2xl border-4 border-gray-800 p-2 shadow-2xl">
              <div className="flex items-center gap-1.5 px-3 py-1.5 bg-[#03120A] rounded-t-xl mb-2">
                ...
                <span className="text-[10px] font-mono text-emerald-400 ml-2">https://www.grstyles.com</span>
              </div>
              <div className="relative overflow-hidden rounded-lg aspect-[16/10]">
                <Image
                  src="/images/gr-styles-mockup.png"
                  alt="GR STYLES e-commerce platform developed by Ashrith Namburi"
                  width={500}
                  height={320}
          ...
          <div className="lg:col-span-5 bg-white dark:bg-[#03120A]/90 border border-slate-200 dark:border-emerald-900/40 rounded-2xl p-6 shadow-md">
            ...
            >
              <Image
                ...
                alt={`GR STYLES platform screenshot ${activeTab + 1} developed by Ashrith Namburi`}
                fill
